...
# Title: Top Block
# Generated: Sun Feb 17 08:06:44 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ntaps=128, rolloff=0.5):
        ...
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_label('Tipos de flitros', "")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/comdiguis/Downloads/Diagrama-de-ojo-Comunicaciones-II/GNU Radio/Datos_Recibidos', False)
        ...
        self.connect((self.blocks_delay_0_0_1, 0), (self.b_Eye_Diagram_simple_0, 0))
        self.connect((self.blocks_delay_0_0_1, 0), (self.blocks_file_sink_0, 0))
